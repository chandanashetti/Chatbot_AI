...
const integrations: Integration[] = [
  ...
  },
  {
    id: 'discord',
    name: 'Discord',
    description: 'Create powerful Discord bots with slash commands and rich interactions',
    icon: DiscordIcon,
    category: 'messaging',
    status: 'connected',
    isPopular: true,
    isPremium: false,
    features: ['Slash Commands', 'Message Components', 'Embeds', 'Voice Channels'],
    metrics: { totalMessages: 7856, successRate: 95.7 }
  },
  {
    id: 'instagram',
